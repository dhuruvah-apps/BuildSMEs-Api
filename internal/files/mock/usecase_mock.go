...
func (m *MockUseCase) GetAll(ctx context.Context, newsID uuid.UUID, query *utils.PaginationQuery) (*models.CommentsList, error) {
	m.ctrl.T.Helper()
...
func (mr *MockUseCaseMockRecorder) GetAll(ctx, newsID, query interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetAll", reflect.TypeOf((*MockUseCase)(nil).GetAll), ctx, newsID, query)
}
