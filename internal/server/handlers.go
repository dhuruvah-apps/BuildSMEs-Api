...
import (
	...
	"github.com/dhuruvah-apps/BuildSMEs-Api/docs"
	...
	authHttp "github.com/dhuruvah-apps/BuildSMEs-Api/internal/auth/delivery/http"
	authRepository "github.com/dhuruvah-apps/BuildSMEs-Api/internal/auth/repository"
	authUseCase "github.com/dhuruvah-apps/BuildSMEs-Api/internal/auth/usecase"
	commentsHttp "github.com/dhuruvah-apps/BuildSMEs-Api/internal/comments/delivery/http"
	commentsRepository "github.com/dhuruvah-apps/BuildSMEs-Api/internal/comments/repository"
	commentsUseCase "github.com/dhuruvah-apps/BuildSMEs-Api/internal/comments/usecase"
	apiMiddlewares "github.com/dhuruvah-apps/BuildSMEs-Api/internal/middleware"
	newsHttp "github.com/dhuruvah-apps/BuildSMEs-Api/internal/news/delivery/http"
	newsRepository "github.com/dhuruvah-apps/BuildSMEs-Api/internal/news/repository"
	newsUseCase "github.com/dhuruvah-apps/BuildSMEs-Api/internal/news/usecase"
	sessionRepository "github.com/dhuruvah-apps/BuildSMEs-Api/internal/session/repository"
	"github.com/dhuruvah-apps/BuildSMEs-Api/internal/session/usecase"
